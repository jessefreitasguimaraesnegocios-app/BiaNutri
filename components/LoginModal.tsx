              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    if (err) setError(err.message || (lang === 'pt' ? 'Erro ao conectar com Google.' : 'Error connecting with Google.'));
                  } finally {
                    setGoogleLoading(false);
                  }
                }}
                disabled={googleLoading}
                className={`w-full py-3 px-4 rounded-xl font-semibold border-2 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed ${
                  theme === 'dark'
