...
| `VITE_ADMIN_EMAILS` | Não | Você define | E-mails que têm acesso de admin: **acesso total sem pagamento e sem trial**. Separados por vírgula (ex.: `admin@email.com,outro@email.com`). |
...
# Opcional: e-mails com acesso admin (sem pagamento e sem trial), separados por vírgula
